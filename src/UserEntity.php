...
class UserEntity extends User
{
    ...
    public function postSave(EntityStorageInterface $storage, $update = TRUE)
    {
        ...
        $this->processEmailGroupsOnSave($update);
    ...
    /**
     * Adds or Removes membership of users into email groups
     *
     * @param $update
     * @throws \Drupal\Core\TypedData\Exception\MissingDataException
     * @throws \Exception
     */
    protected function processEmailGroupsOnSave($update)
    {
        if(!$update) {
            return;
        }

        $user_emails = $this->getActiveEmails();

        /** @var $group GroupEntity */
        foreach($this->getEmailDomainGroups() as $group) {
    ...
    /**
     * Gets all active email addresses for a user
     */
